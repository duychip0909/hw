<?php
    ...
    function sendEmail($recipient){
        ...
        try{
            ...
            $mail->Password = 'evdvemqydathelim'; // SMTP password bqicengzsrdwtrdf
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;// Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
            $mail->Port = 587; // TCP port to connect to
            $mail->CharSet = 'UTF-8';

            // Cấu hình thuộc tính hiển thị của người gửi - người nhận
            $mail->setFrom('duychip9901@gmail.com', 'Highway Menswear Team');
            // Tên hiển thị: TÊN CÁC BẠN, ví dụ: Nguyễn Sơn Lâm

            $mail->addReplyTo('duychip9901@gmail.com', 'Highway Menswear Team');

            $mail->addAddress($recipient); // Đây là địa chỉ Email người nhận > sau này sẽ là BIẾN
            // Gửi tới: kitudu99@gmail.com
            // Tiêu đề Email là gì?
            $mail->isHTML(true);   // Set email format to HTML
            $mail->Subject = '[Highway Menswear Team] Thanks for Register';
            // Nội dung Email
            $mail->Body = 'Thanks for being one of first people to use this services';
